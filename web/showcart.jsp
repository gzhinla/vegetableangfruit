...
<header>
    <nav class="navbar navbar-inverse" role="navigation">
     <div class="logo"></div>
        ...
        <a href="javascript:void(0)" onclick="phone('手机')">高原果蔬</a>
        <a href="javascript:void(0)" onclick="phone('平板')">热带果蔬</a>
        <a href="javascript:void(0)" onclick="phone('笔记本')">进口果蔬</a>
        <a href="javascript:void(0)" onclick="phone('配件')">优选农场果蔬</a>
